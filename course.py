...
class Course(object):
    ...
    """
    def __init__(self,index=None,course_name=None,start_date=None,end_date=None,lesson_weekday=None,
                 start_time=None,end_time=None,effectiveness=1):
        self.course_dict = {'index': 0, 'course_name': 0, 'start_date': 0, 'end_date': 0,
                         'lesson_weekday': 0, 'start_time': 0,'end_time': 0, 'effectiveness': 0}
        self.course_dict['index'] = index
